<div class="container">
  ...
  <div class="row">
    <div class="col-sm-6">
      <form id="form-ingresar-usuario" class="" action="<?php echo base_url();?>index.php/usuario/ingresarusuario" method="post">
        <div class="form-group">
          <label for="correo-usuario">Correo:</label>
          <input type="email" class="form-control" id="correo-usario" name="correo-usuario" placeholder="" required>
        </div>
        <div class="form-group">
